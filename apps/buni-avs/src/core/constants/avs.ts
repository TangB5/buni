...
export const AVS_PATTERN_TYPES = ['kente','bogolan','adinkra','ndebele','kuba','berber','maasai','ankara','ndop','wax'] as const;
export type  AvsPatternType = typeof AVS_PATTERN_TYPES[number];
